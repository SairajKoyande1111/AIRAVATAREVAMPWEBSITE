      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10 max-w-7xl">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-[300px] md:max-w-none mx-auto leading-relaxed font-light text-center px-4">
              The principles that guide our approach to technology,<br />
